            ...
            <div className='bg-white w-full p-5 mt-5 rounded-t-xl'>
                <div className="shadow-md p-5 rounded-md  border">
                    <label>
                        ...
                        <input type={"text"} className="border w-full rounded-md px-2 py-1" value={value} onClick={() => setCopied(false)} onChange={({ target: { value } }) => setValue(value)} required/>
                    </label>
                    <CopyToClipboard text={`Kepada Yth. \nBapak/Ibu/Saudara/i \nSalam Sejahtera, \nTanpa mengurangi rasa hormat, melalui undangan virtual ini kami mengundang Bapak/Ibu Saudara/i untuk hadir di acara bahagia kami🌻 \nUntuk detail mengenai acara kami, silakan lihat link undangan dibawah ini☺️ \nhttps://randkhiepermata-wedding.web.app/?to=${spaceToPlus(value)} \nKami memohon doa terbaik untuk kelancaran atas setiap langkah dan proses yang kami lalui✨ \nTerima kasih. \nYang berbahagia \n \n \n \n \n \n Randkhi & Permata \n-------------------------`} onCopy={() => setCopied(true)}>
